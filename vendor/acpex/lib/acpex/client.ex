defmodule ACPex.Client do
  ...
  @doc """
  Handle asynchronous messages delivered to the session process.

  This callback is optional. Implement it when your client spawns background workers
  or monitors processes and needs to update internal state from async events.
  """
  @callback handle_info(message :: term(), state()) :: {:noreply, state()}
